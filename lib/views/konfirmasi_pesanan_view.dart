          ...
          children: [
            Row(
              ...
              children: [
                ...
                Obx(() => Text("Rp ${trxC.totalTagihan.toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}", style: const TextStyle(color: Color(0xFFB71C1C), fontSize: 20, fontWeight: FontWeight.bold))),
              ],
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () => trxC.buatTransaksi(idCustomer),
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.orange, padding: const EdgeInsets.symmetric(vertical: 16),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                ),
                child: const Text("Buat Transaksi", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white)),
              ),
            ),
          ],
        ),
                    ...
                    if (trxC.deliveryFee.value > 0)
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text("Rp ${trxC.deliveryFee.value.toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF102A43))),
                              const SizedBox(width: 12),
                              InkWell(
                                onTap: trxC.hapusOngkir,
                      ...
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text("Rp ${item['harga_satuan']} • ${item['durasi_jam']} Jam", style: const TextStyle(color: Colors.grey, fontSize: 12)),
                                ],
                              ),
                            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: const Padding(padding: EdgeInsets.symmetric(horizontal: 10, vertical: 6), child: Icon(Icons.remove, size: 16, color: Colors.blue)),
                                  ),
                                  Text("${item['kuantitas'].toInt()}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF102A43))),
                                  InkWell(
                                    onTap: () => trxC.ubahQtyCart(index, item['kuantitas'] + 1),
                                    child: const Padding(padding: EdgeInsets.symmetric(horizontal: 10, vertical: 6), child: Icon(Icons.add, size: 16, color: Colors.blue)),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            Text("Rp ${item['subtotal_harga']}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF102A43))),
                            const SizedBox(width: 12),

                            InkWell(
                              onTap: () => trxC.removeCartItemByServiceId(item['service_id']),
