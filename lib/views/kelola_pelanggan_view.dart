            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String nama = pelanggan['nama'].toString();
                  String telepon = pelanggan['telepon'].toString();

                  String inisial = nama.trim().split(' ').map((l) => l[0]).take(2).join().toUpperCase();
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => pelC.goToDetail(nama, telepon), 
                            ...
                            IconButton(
                              ...
                              onPressed: () => pelC.hapusPelanggan(pelanggan['id'] as int, nama),
                            ),
                          ],
                        ),
                      ],
